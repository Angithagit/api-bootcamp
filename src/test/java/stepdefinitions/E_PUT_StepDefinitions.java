...
public class E_PUT_StepDefinitions {
...
@When("the user sends a PUT request for {string}")
public void the_user_sends_a_put_request_for(String testCaseName) {
     ...
     if ("TRUE".equalsIgnoreCase(useCaptured)) {
         ...
         endpoint = baseEndpoint + TestContext.getCreatedUserId(); 
     } else {
...
public void the_response_status_should_match_the_expected_from_excel_for_put_user_creation() {
